...
* To monitor the logs of the container in realtime: `docker logs -f mysql-workbench`
...
* Update the image: `docker pull linuxserver/mysql-workbench`
...
* Start the new container: `docker start mysql-workbench`
